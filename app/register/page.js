...
import { FiMail, FiLock, FiAlertCircle, FiUserCheck } from "react-icons/fi";
      ...
      >
        <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl shadow-[0_0_25px_rgba(124,58,237,0.15)] overflow-hidden">
          ...
          >
            ...
            <div className="mb-6">
              <label className="text-blue-200 text-sm font-medium mb-2 flex items-center" htmlFor="confirmPassword">
                <FiUserCheck className="mr-2 text-blue-300/70" />
            ...
            >
              ...
              >
                ...
                <span className="ml-1 font-medium text-violet-400 hover:text-violet-300 transition-colors">Sign in</span>
              </Link>
            </motion.div>
          </motion.form>
        </div>
